// Créez une application todo list:
// Votre application devra posséder un champ input text pour le nom de la tache ainsi qu’un bouton pour ajouter une tache. le bouton devra posséder l’id “addTodo”
// Les tâches seront affichées dans une liste ul>li, chaque tâche possédera un bouton permettant de supprimer la tâche de la liste.
...
while (true) {
  ...
  if (targetAction.length === 0) {console.log("commande introuvable"); continue;}
